...
btn_high = Button(root, text="High Resolution", bg="gray", fg="white", command=lambda: download_video("high")).pack(pady=5)
btn_low = Button(root, text="Low Resolution", bg="blue", fg="white", command=lambda: download_video("low")).pack(pady=5)
btn_audio = Button(root, text="Audio Only", bg="gold", fg="white", command=lambda: download_video("audio")).pack(pady=5)
